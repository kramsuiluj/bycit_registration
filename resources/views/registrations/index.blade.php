<x-layout>
    ...
    <div class="w-11/12 mx-auto mb-5 font-montserrat pb-5 flex justify-between">
        <div class="flex items-center space-x-1">
            <form action="">
             ...
             focus:ring-purple-300 font-medium rounded-md text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600
             dark:hover:bg-purple-700 dark:focus:ring-purple-900">Filter</button>
            </form>
            ...
            >
                ...
                focus:outline-none
                focus:ring-4
             focus:ring-green-300 font-medium rounded-md text-sm px-5 py-2.5 text-center mb-2 dark:bg-green-600
             dark:hover:bg-green-700 dark:focus:ring-green-900">Export Participant Records</button>
            </form>
        </div>

        <p class="text-white drop-shadow-lg text-lg">Total Records: <span class="font-bold">{{ $totalRegistrations
        }}</span></p>
    </div>
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            <div class="flex justify-center space-x-2">
                                                <button id="{{ $registration->id }}" onclick="updateConfirmation(this)"
                                                        class="bg-blue-500
                                                        text-white px-3
                                                        py-1
                                                rounded-md" style="font-weight: 400">
                                                    {{ $registration->confirmed == 'yes' ? 'Unconfirm' : 'Confirm' }}
                                                </button>
                                                ...
                                                rounded-md" style="font-weight: 400" data-modal-target="popup-modal" data-modal-toggle="popup-modal">Delete
                                                </button>
