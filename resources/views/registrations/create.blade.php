    ...
    <section class="w-10/12 mx-auto font-montserrat space-y-5 mb-24 sm:w-3/5 sm:ml-20">
        ...
        <div class="space-y-5">
            ...
            <div class="" id="others-container" style="display: none">
                <div class="w-full">
                    <select name="course" id="course" class="w-full p-4 rounded-md bg-gray-100 text-sm sm:text-base
                    sm:p-4.5
                ...
                <div class="w-full">
                    <select name="year" id="year" class="w-full p-4 rounded-md bg-gray-100 text-sm sm:text-base
                    sm:p-4.5
