<x-layout>
    ...
    <section class="w-10/12 mx-auto font-montserrat space-y-5 mb-24 sm:w-3/5 sm:ml-20">
        ...
        <div>
            <div class="flex text-white space-x-6">
                ...
                <div class="flex items-center space-x-2">
                    <input onclick="getType(this)" form="register" type="radio" name="type" value="Teacher" id="teacher"
    ...
    <div class="font-montserrat">
        ...
        <div id="modal-content" style="display: none;" class="absolute bg-white center px-5 py-5 rounded-md space-y-5
        w-80 sm:w-128">
